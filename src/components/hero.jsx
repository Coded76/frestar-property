        ...
        >
          ...
          >
            <motion.button
              ...
              className="bg-[#F2F2F2]  hidden w-[106px] h-[40px] md:flex flex-row gap-2.5 text-[#00143F] font-bold items-center justify-center rounded-md"
            >
